/*
	...
	说明：
	用法（二选一）：
	deno run --allow-read --allow-write --allow-net P:\2022\20220613a\3code\9_tools\deno\imageHelper\createEduSonyaCcQrCodeStory.ts
	cls && deno run --allow-read --allow-write --allow-net P:\2022\20220613a\3code\9_tools\deno\imageHelper\createEduSonyaCcQrCodeStory.ts
	
	查看注释
	P: && CD P:\2022\20220613a\3code\9_tools\deno\imageHelper\ && deno doc createEduSonyaCcQrCodeStory.ts
*/
...
for(let id = 1; id <= 100; ++id) {
	const name = `story/${id}`;
	create(name, `http://http://edu.sonya.cc/?go=story&id=${id}`);
