/*
	...
	说明：
	用法（二选一）：
	deno run --allow-read --allow-write --allow-net P:\2022\20220613a\3code\9_tools\deno\imageHelper\createEduSonyaCcQrCodeBrick.ts
	cls && deno run --allow-read --allow-write --allow-net P:\2022\20220613a\3code\9_tools\deno\imageHelper\createEduSonyaCcQrCodeBrick.ts
	
	查看注释
	P: && CD P:\2022\20220613a\3code\9_tools\deno\imageHelper\ && deno doc createEduSonyaCcQrCodeBrick.ts
*/
...
for(let id = 1; id <= 100; ++id) {
	const name = `brick/${id}`;
	create(name, `http://http://edu.sonya.cc/?go=brick&id=${id}`);
